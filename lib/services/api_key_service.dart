...
class ApiKeyService {
  ...
  static Future<void> initialize() async {
    ...
    try {
      ...
      if (Environment.isProduction) {
        ...
        throw Exception('Production app cannot start without valid API keys: $e');
      }
    }
  }
  ...
  static void _validateGoogleMapsKey() {
    ...
    if (Environment.isDevelopment && mapsKey == 'AIzaSyDY6Xx10omIllIivBo4TOiegLMRvm2E7Xs') {
  ...
  static String getMapsApiKey() {
    if (!_isInitialized) {
      throw Exception('ApiKeyService not initialized. Call initialize() first.');
    }
