...
class BluetoothPermissionHelper {
          ...
          title: Row(
            children: [
              Icon(
                ...
                color: permissionResult.hasPermissions ? Colors.green : Colors.orange,
              ),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          _getInstructionText(permissionResult.settingsType),
                          style: TextStyle(
                            fontSize: 14,
              ...
              ElevatedButton.icon(
                ...
                onPressed: () async {
                  ...
                  if (permissionResult.settingsType != null) {
                    await BluetoothService.openBluetoothSettings(permissionResult.settingsType!);
                  }
                },
  ...
  static Future<bool> requestPermissionsWithDialog(BuildContext context) async {
    ...
    BluetoothPermissionResult result = await BluetoothService.requestPermissionsWithSetup();
  ...
  static void _showPostSettingsDialog(BuildContext context, BluetoothSettingsType? settingsType) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
  ...
  static String _getPostSettingsInstructions(BluetoothSettingsType? settingsType) {
    switch (settingsType) {
      case BluetoothSettingsType.bluetooth:
